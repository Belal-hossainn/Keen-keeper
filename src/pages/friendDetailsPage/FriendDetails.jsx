...
const FriendDetails = () => {
   ...
   const { name, picture, days_since_contact, tags, status, goal, next_due_date, bio } = friend;
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="card bg-base-100 p-6 shadow">
              ...
              <div className="grid grid-cols-3 gap-6">
                <button className="btn bg-[#F8FAFC] text-[#1F2937] shadow flex flex-col h-20 gap-2">
